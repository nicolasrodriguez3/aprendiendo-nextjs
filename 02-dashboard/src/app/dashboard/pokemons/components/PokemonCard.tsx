...
export const PokemonCard = ({ pokemon }: Props) => {
    ...
    return (
        <div className="max-w-sm w-60 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 p-5 relative">
            ...
            <Link href={`/dashboard/pokemons/${name}`} className="flex items-center justify-center w-full h-32 mb-2">
            ...
            <div>
                ...
                <Link href={`/dashboard/pokemons/${name}`} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Read more
